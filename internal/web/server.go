...
func New(cfg Config) *Server {
	...
	mux.HandleFunc("POST /api/hash", s.hashFiles)
	...
	mux.HandleFunc("GET /api/share/list", s.shareList)
	mux.HandleFunc("GET /api/share/file/{name}", s.shareFile)
	mux.HandleFunc("GET /api/peer/files", s.peerFiles)
	mux.HandleFunc("POST /api/peer/copy", s.copyFromPeer)
